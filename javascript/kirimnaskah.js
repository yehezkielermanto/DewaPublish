...
function checkValidate(){
    // Get the modal
    var modal = document.getElementById("modal_kirim");
    var upload = $('#real_file').val();
    ...
    if(checked > 0){
        ...
        $(".fielderror_7").html("Pilihan Kosong!");
...
function upfile(){
  ...
  if (realFileBtn.value) {
    ...
    customTxt.innerHTML = "Tidak ada file yang dipilih.";
  }
});
